...
public class RecipeCommandToRecipeTest {
	...
	public void setUp() {
		...
		recipeCommandToRecipe = new RecipeCommandToRecipe(categoryConveter, ingredientConverter, notesConverter);
	}
	...
	public void testConvert() {
        ...
        assertEquals(recipeCommand.getIngredient().size(), recipe.getIngredient().size());
	}
